...
public class CheckSphere1 : MonoBehaviour
{
    ...
    public  bool isCorrectTargetInPlace1 = false;
    ...
    void Update()
    {
        ...
        if (correctTargetInRange && !isCorrectTargetInPlace1)
        {
            isCorrectTargetInPlace1 = true;
            UpdateTexture(true);  // Met à jour la texture à la bonne valeur
        }
        else if (!correctTargetInRange && isCorrectTargetInPlace1)
        {
            isCorrectTargetInPlace1 = false;
