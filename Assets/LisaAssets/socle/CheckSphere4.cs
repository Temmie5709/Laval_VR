...
public class CheckSphere4 : MonoBehaviour
{
    ...
    public  bool isCorrectTargetInPlace4 = false;
    ...
    void Update()
    {
        ...
        if (correctTargetInRange && !isCorrectTargetInPlace4)
        {
            isCorrectTargetInPlace4 = true;
            UpdateTexture(true);  // Met à jour la texture à la bonne valeur
        }
        else if (!correctTargetInRange && isCorrectTargetInPlace4)
        {
            isCorrectTargetInPlace4 = false;
